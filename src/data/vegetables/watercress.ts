  ...
  // ── Generated varieties (from @cropgraph/core) ──────────────────────────
    {
      ...
      yieldDescription: 'Moderate to good yields of improved. EXPAND-ME: Add yield details.',
      maxPlantsPerPerson: 2,
      description: 'Improved Watercress is a cool-season watercress variety. Matures in 45 days. Aquatic edge layer. Edible peppery leaves, vitamin C and K dense. Cool flowing water ideal, but moist garden bed also works. Hardy perennial. [Source: Kitazawa Seed; Rocky Mountain Watercress Co] EXPAND-ME: Add UK-specific growing context and flavour notes.',
    ...
    },
    {
      ...
      yieldDescription: 'Moderate to good yields of wasabi-flavored. EXPAND-ME: Add yield details.',
      maxPlantsPerPerson: 2,
      description: 'Wasabi-Flavored Watercress is a perennial watercress variety. Matures in 45 days. Pungent strain selected for intense horseradish-like heat. Use only in clean cold water; never wild-collected streams. [Source: Plants for a Future; Adaptive Seeds catalog] EXPAND-ME: Add UK-specific growing context and flavour notes.',
    ...
    },
    {
      ...
      plantOutWeeksAfterLastFrost: undefined,
      harvestPeriodWeeks: 6,
      yieldDescription: 'Moderate to good yields of aquatic watercress uk. EXPAND-ME: Add yield details.',
      maxPlantsPerPerson: 2,
      description: 'Aquatic Watercress UK is a perennial watercress variety. Matures in 45 days. Classic UK strain for chalk-stream cultivation. Milder than wasabi-flavored strain. Cool-water requires 50-60F. [Source: Royal Horticultural Society; Plants for a Future] EXPAND-ME: Add UK-specific growing context and flavour notes.',
      growingInstructions: 'Sow. EXPAND-ME: Add detailed UK-specific growing advice.',
      commonProblems: ['Aphids', 'Slugs'],
      goodCompanions: [],
      badCompanions: [],
