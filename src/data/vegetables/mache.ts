  ...
  // ── Generated varieties (from @cropgraph/core) ──────────────────────────
    {
      ...
      yieldDescription: 'Moderate to good yields of lamb\'s quarters. EXPAND-ME: Add yield details.',
      maxPlantsPerPerson: 2,
      description: 'Lamb\'s Quarters is a cool-season mache variety. Matures in 30 days. Wild-foraged or self-seeded. Cooked like spinach; high in oxalate so eat in moderation. [Source: Cornell Cooperative Extension - Wild Edibles] EXPAND-ME: Add UK-specific growing context and flavour notes.',
    ...
    },
    {
      ...
      plantOutWeeksAfterLastFrost: undefined,
      harvestPeriodWeeks: 4,
      yieldDescription: 'Moderate to good yields of vit mache. EXPAND-ME: Add yield details.',
      maxPlantsPerPerson: 2,
      description: 'Vit Mache is a cool-season mache variety. Matures in 50 days. Cold-hardy mache cultivar; long narrow leaves. Tolerates -5F under cold frame. Very nutty mild flavor; doesn\'t bolt in cool weather. [Source: Cornell Cooperative Extension - Cold-Frame Greens] EXPAND-ME: Add UK-specific growing context and flavour notes.',
